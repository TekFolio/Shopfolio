...
class Edit extends AbstractBaseComponent
{
    ...
    public function rules(): array
    {
        return [
            'code' => [
                'sometimes',
                'required',
                Rule::unique(shopfolio_table('discounts'), 'code')->ignore($this->discountId),
            ],
    ...
    public function store()
    {
        ...
        session()->flash('success', __('shopfolio::pages/discounts.update_message', ['code' => $this->code]));
    ...
    {
        return view('shopfolio::livewire.discounts.edit');
    }
}
