...
use Shopfolio\Repositories\ChannelRepository;
...
class Initialization extends Component
{
    ...
    {
        $defaultCurrency = Currency::where('code', shopfolio_currency())->first();
    ...
    {
        return [
            'shop_country_id.required' => __('shopfolio::pages/settings.validations.country'),
            'shop_name.required' => __('shopfolio::pages/settings.validations.shop_name'),
        ];
    }
    ...
    public function store()
    {
        ...
        $this->redirectRoute('shopfolio.dashboard');
    }
    ...
    {
        return view('shopfolio::livewire.initialization', [
