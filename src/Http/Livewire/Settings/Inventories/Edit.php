...
class Edit extends AbstractBaseComponent
{
    ...
    public function rules(): array
    {
        return [
            'email' => [
                'required',
                'email',
                Rule::unique(shopfolio_table('inventories'), 'email')->ignore($this->inventoryId),
            ],
            ...
            'country_id' => 'required|exists:' . shopfolio_table('system_countries') . ',id',
        ];
    }
    ...
    {
        return view('shopfolio::livewire.settings.inventories.edit', [
