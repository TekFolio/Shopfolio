...
namespace Shopfolio\Http\Livewire\Settings\Integrations;
...
class Browse extends Component
{
    ...
    {
        $this->github = env('SHOPFOLIO_INTEGRATION_GITHUB', false);
        $this->twitter = env('SHOPFOLIO_INTEGRATION_TWITTER', false);
    }
    ...
    {
        setEnvironmentValue(['shopfolio_integration_' . mb_strtolower($this->currentProvider) => true]);
    ...
    {
        return view('shopfolio::livewire.settings.integrations.browse');
    }
