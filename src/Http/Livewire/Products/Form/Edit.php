...
class Edit extends AbstractBaseComponent
{
    ...
    public function mount($product, string $currency)
    {
        ...
        $this->images = $product->getMedia(config('shopfolio.system.storage.disks.uploads'));
    }
    ...
    {
        $this->images = $this->product->getMedia(config('shopfolio.system.storage.disks.uploads'));
    }
    ...
    public function store(): void
    {
        ...
        $this->notification()->success(
            ...
            __('shopfolio::pages/products.notifications.update')
        );
    }

    public function render(): View
    {
        return view('shopfolio::livewire.products.forms.form-edit', [
