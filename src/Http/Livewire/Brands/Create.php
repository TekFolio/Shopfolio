...
class Create extends AbstractBaseComponent
{
    ...
    public function store(): void
    {
        ...
        if ($this->fileUrl) {
            $brand->addMedia($this->fileUrl)->toMediaCollection(config('shopfolio.system.storage.disks.uploads'));
        }
    ...
    {
        return [
            'name' => 'required|max:150|unique:' . shopfolio_table('brands'),
        ];
    }

    public function render(): View
    {
        return view('shopfolio::livewire.brands.create');
    }
}
