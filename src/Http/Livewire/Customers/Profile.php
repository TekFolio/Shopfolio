...
class Profile extends Component
{
    ...
    public function saveEmail()
    {
        $this->validate([
            'email' => [
                ...
                'required',
                'email',
                Rule::unique(shopfolio_table('users'), 'email')->ignore($this->customer_id),
            ],
        ]);
    ...
    {
        return view('shopfolio::livewire.customers.profile');
    }
    ...
    private function updateValue(string $field, mixed $value, string $message)
    {
        ...
        $this->notification()->success(__('shopfolio::layout.status.updated'), __($message));
    }
}
