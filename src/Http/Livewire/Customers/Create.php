...
use Shopfolio\Notifications\CustomerSendCredentials;
use Shopfolio\Repositories\UserRepository;
use Shopfolio\Rules\Phone;
use Shopfolio\Traits\WithAddress;
...
class Create extends AbstractBaseComponent
{
    ...
    public function store()
    {
        ...
        $customer->assignRole(config('shopfolio.system.users.default_role'));
        ...
        $this->redirectRoute('shopfolio.customers.show', $customer);
    }
    ...
    public function rules(): array
    {
        return array_merge($this->addressRules(), [
            'email' => 'required|max:150|unique:' . shopfolio_table('users'),
            'first_name' => 'required',
            'last_name' => 'required',
            'country_id' => 'required',
    ...
    {
        return view('shopfolio::livewire.customers.create', [
