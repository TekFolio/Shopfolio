...
class AddProductAttribute extends ModalComponent
{
    ...
    public function save()
    {
        ...
        $this->notification()->success(
            __('shopfolio::pages/products.attributes.session.added'),
            __('shopfolio::pages/products.attributes.session.added_message')
        );
    ...
    {
        return view('shopfolio::livewire.modals.add-product-attribute');
    }
}
