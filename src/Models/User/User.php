...
namespace Shopfolio\Models\User;
...
use Shopfolio\Models\Traits\HasProfilePhoto;
use Shopfolio\Services\TwoFactor\TwoFactorAuthenticatable;
...
class User extends Authenticatable
{
    ...
    {
        return $this->hasRole(config('shopfolio.system.users.admin_role'));
    }
    ...
    public function getBirthDateFormattedAttribute(): string
    {
        ...
        return __('shopfolio::messages.not_defined');
    }
