...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | List with Shopfolio components.
    ...
    */
    ...
    | for your app. By default all components from Shopfolio Kit are loaded in.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | This value will set a prefix for all Shopfolio Admin components.
    | By default it's shopfolio. This is useful if you want to avoid
    | collision with components from other libraries.
    |
    | For example, it's reference components like:
    |
    | <x-shopfolio-input.textarea />
    | <livewire:shopfolio-products.create />
    |
    */
