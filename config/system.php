...
return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Shopfolio Locale Configuration
    |--------------------------------------------------------------------------
    |
    | Shopfolio PHP locale determines the default locale that will be used
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | This prefix table can be used for the prefix of each shopfolio
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Shopfolio Controllers config
    |--------------------------------------------------------------------------
    |
    | If you want extends your shopfolio admin panel with great features,
    | Here you can specify custom Controller Namespace and Shopfolio
    ...
    */
    ...
    'controllers' => [
        ...
        'namespace' => 'App\\Http\\Controllers\\Shopfolio',

    ],

    /*
    |--------------------------------------------------------------------------
    | Shopfolio Ecommerce Model
    |--------------------------------------------------------------------------
    |
    | Here you may specify the ecommerce class used by Shopfolio for the
    ...
    */
    ...
    'models' => [
         ...
         * `\Shopfolio\\Models\Shop\Product\Brand` model.
         */

        'brand' => \Shopfolio\\Models\Shop\Product\Brand::class,
         ...
         * `\Shopfolio\\Models\Shop\Product\Category` model.
         */

        'category' => \Shopfolio\\Models\Shop\Product\Category::class,
         ...
         * `\Shopfolio\\Models\Shop\Product\Collection` model.
         */

        'collection' => \Shopfolio\\Models\Shop\Product\Collection::class,
         ...
         * `\Shopfolio\\Models\Shop\Product\Product` model.
         */

        'product' => \Shopfolio\\Models\Shop\Product\Product::class,
