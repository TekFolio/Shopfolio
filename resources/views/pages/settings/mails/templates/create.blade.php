...
<x-shopfolio::layouts.setting :title="__('Mail ~ Create Template')">

    <x-shopfolio::breadcrumb back="shopfolio.settings.mails.select-template">
        <x-heroicon-s-chevron-left class="shrink-0 h-5 w-5 text-secondary-400" />
        <x-shopfolio::breadcrumb.link :link="route('shopfolio.settings.mails.select-template')" title="Templates" />
    ...
    <div class="mt-6 pb-10 overflow-hidden">
        <form action="{{ route('shopfolio.settings.mails.store-template') }}" method="POST">
            @csrf
            ...
            <div class="grid gap-4 sm:grid-cols-4 sm:gap-6">
                ...
                <div class="sm:col-span-1 space-y-5">
                    <x-shopfolio::forms.group for="name" label="Template name" :error="$errors->first('template_name')" isRequired>
                        <x-shopfolio::forms.input name="template_name" type="text" id="name" placeholder="Shopfolio Newsletter" />
                    </x-shopfolio::forms.group>
                    <x-shopfolio::forms.group for="description" label="Template description" :error="$errors->first('template_description')" isRequired>
                        <x-shopfolio::forms.textarea name="template_description" id="description" />
                    </x-shopfolio::forms.group>
