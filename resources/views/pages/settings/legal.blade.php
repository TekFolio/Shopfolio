<x-shopfolio::layouts.setting :title="__('Legal setting')">
    ...
    >
        ...
        <div class="mt-6">
            <div x-show="currentTab === 'refund'">
                <livewire:shopfolio-settings.legal.refund />
            </div>
            <div x-cloak x-show="currentTab === 'privacy'">
                <livewire:shopfolio-settings.legal.privacy />
            </div>
            <div x-cloak x-show="currentTab === 'terms'">
                <livewire:shopfolio-settings.legal.terms />
            </div>
            <div x-cloak x-show="currentTab === 'shipping'">
                <livewire:shopfolio-settings.legal.shipping />
            </div>
        </div>

        <x-shopfolio::learn-more name="legal pages" link="legal" />
    </div>
