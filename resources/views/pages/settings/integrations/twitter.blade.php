@extends('shopfolio::layouts.default')
...
@section('content')
    ...
    >
        <x-shopfolio::breadcrumb back="shopfolio.settings.integrations">
            <svg class="shrink-0 h-5 w-5 text-secondary-400" fill="currentColor" viewBox="0 0 20 20">
                <path fill-rule="evenodd" d="M12.707 5.293a1 1 0 010 1.414L9.414 10l3.293 3.293a1 1 0 01-1.414 1.414l-4-4a1 1 0 010-1.414l4-4a1 1 0 011.414 0z" clip-rule="evenodd"/>
            </svg>
            <a href="{{ route('shopfolio.settings.integrations') }}" class="text-secondary-500 hover:text-secondary-700 focus:outline-none focus:underline transition duration-150 ease-in-out">{{ __('Integrations') }}</a>
            ...
            <div>
                ...
                <div class="hidden sm:block">
                    <nav class="-mb-px flex space-x-8">
                        <button @click="currentTab = 'products'" type="button" class="whitespace-no-wrap pb-4 px-1 border-b-2 border-transparent group inline-flex items-center font-medium text-sm leading-5 text-secondary-500 hover:text-secondary-700 hover:border-secondary-300 focus:outline-none focus:text-secondary-700 focus:border-secondary-300" aria-current="page" :class="{ 'border-primary-500 text-primary-600 focus:text-primary-800 focus:border-primary-700': currentTab === 'products' }">
...
{{--                <livewire:shopfolio-settings.integrations.github.issues />--}}
            </div>
            <div x-cloak x-show="currentTab === 'setting'">
{{--                <livewire:shopfolio-settings.integrations.github.settings />--}}
            </div>
        </div>
    </div>
