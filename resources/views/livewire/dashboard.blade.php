<div>
    <div class="flex items-center space-x-2">
        ...
        <h2 class="welcome text-3xl leading-8 font-bold text-secondary-900 dark:text-white sm:leading-9 sm:truncate">
            {!! __('shopfolio::messages.dashboard.welcome_message') !!}
        </h2>
    </div>
    ...
    <div class="my-8 bg-white dark:bg-secondary-800 overflow-hidden shadow-lg rounded-lg">
        <div class="p-6 border-b border-secondary-200 dark:border-secondary-700">
            <div class="text-xl text-secondary-900 dark:text-white font-medium">
                {{ __('shopfolio::messages.dashboard.header') }}
            </div>

            <div class="welcome-description mt-4 text-secondary-500 dark:text-secondary-400">
                {!! __('shopfolio::messages.dashboard.description') !!}
            </div>
        </div>
        ...
        <div class="bg-secondary-50 dark:bg-secondary-700 grid grid-cols-1 md:grid-cols-2">
            <div class="px-6 py-5">
                <div class="flex items-center">
                    ...
                    <h4 class="ml-4 text-base text-secondary-900 dark:text-white leading-6 font-medium">
                        {{ __('shopfolio::messages.dashboard.cards.doc_title') }}
                    </h4>
                </div>

                <div class="ml-10">
                    <div class="mt-4 text-sm text-secondary-500 dark:text-secondary-400">{{ __('shopfolio::messages.dashboard.cards.doc_description') }}</div>

                    <a href="https://laravelshopper.dev" class="group">
                        <div class="mt-3 flex items-center text-sm font-medium text-primary-600">
                            <span>{{ __('shopfolio::messages.dashboard.cards.doc_link') }}</span>
            ...
            <div class="px-6 py-5 border-t border-secondary-200 dark:border-secondary-600 sm:border-t-0">
                <div class="flex items-center">
                    ...
                    <h4 class="ml-4 text-base text-secondary-900 dark:text-white leading-6 font-medium">{{ __('shopfolio::messages.dashboard.cards.screencast_title') }}</h4>
                </div>

                <div class="ml-10">
                    <div class="mt-4 text-sm text-secondary-500 dark:text-secondary-400">
                        {{ __('shopfolio::messages.dashboard.cards.screencast_description') }}
                    </div>

                    <a href="https://www.youtube.com/channel/UCgxgoKJi3VA1eXxtjIs2tKw" class="group">
                        <div class="mt-3 flex items-center text-sm font-medium text-primary-600">
                            <span>{{ __('shopfolio::messages.dashboard.cards.screencast_link') }}</span>
            ...
            <div class="px-6 py-5 border-t border-secondary-200 dark:border-secondary-600">
                <div class="flex items-center">
                    ...
                    <h4 class="ml-4 text-base text-secondary-900 dark:text-white leading-6 font-medium">{{ __('shopfolio::messages.dashboard.cards.theme_title') }}</h4>
                </div>

                <div class="ml-10">
                    <div class="mt-2 text-sm text-secondary-500 dark:text-secondary-400">
                        {{ __('shopfolio::messages.dashboard.cards.theme_description') }}
                    </div>

                    <a href="#" class="group">
                        <div class="mt-3 flex items-center text-sm font-medium text-primary-600">
                            <span>{{ __('shopfolio::messages.dashboard.cards.theme_link') }}</span>
            ...
            <div class="px-6 py-5 border-t border-secondary-200 dark:border-secondary-600">
                <div class="flex items-center">
                    ...
                    <h4 class="ml-4 text-base text-secondary-900 dark:text-white leading-6 font-medium">{{ __('shopfolio::messages.dashboard.cards.product_title') }}</h4>
                </div>

                <div class="ml-10">
                    <div class="mt-2 text-sm text-secondary-500 dark:text-secondary-400">
                        {{ __('shopfolio::messages.dashboard.cards.product_description') }}
                    </div>

                    @can('add_products')
                        <a href="{{ route('shopfolio.products.create') }}" class="group">
                            <div class="mt-3 flex items-center text-sm font-medium text-primary-600">
                                <span>{{ __('shopfolio::messages.dashboard.cards.product_link') }}</span>
