<div>
    ...
    <x-shopfolio::heading>
        <x-slot name="title">
            {{ __('shopfolio::layout.sidebar.brands') }}
        </x-slot>
            ...
            @if($total > 0)
                @can('add_brands')
                    ...
                    <span class="shadow-sm rounded-md">
                        <x-shopfolio::buttons.primary :link="route('shopfolio.brands.create')">
    ...
    @if($total === 0)
        <x-shopfolio::empty-state
            :title="__('shopfolio::pages/brands.title')"
            :content="__('shopfolio::pages/brands.content')"
            :button="__('shopfolio::messages.actions_label.add_new', ['name' => 'brand'])"
            permission="add_brands"
            :url="route('shopfolio.brands.create')"
        >
            <div class="shrink-0">
    ...
    @else
        <div class="mt-6">
            <livewire:shopfolio-tables.brands-table />
        </div>
    @endif

    <x-shopfolio::learn-more name="shopfolio::layout.sidebar.brands" link="brands" />
