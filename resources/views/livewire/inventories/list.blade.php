    ...
    >
        <div class="bg-white border-b border-secondary-200">
            <div class="sm:hidden p-4">
                <select x-model="currentTab" aria-label="Selected tab" class="form-select form-select-shopfolio block w-full pl-3 pr-10 py-2 text-base leading-6 sm:text-sm sm:leading-5 transition ease-in-out duration-150">
                            ...
                            @forelse($products as $product)
                                <tr class="hover:bg-secondary-50">
                                    <td class="px-6 py-4 border-b border-secondary-200">
                                        <a href="{{ route('shopfolio.products.edit', $product) }}" class="flex items-center">
        ...
        <div class="rounded-b-md bg-white px-4 py-3 flex items-center justify-between sm:px-6">
            <div class="flex-1 flex justify-between sm:hidden">
                {{ $products->links('shopfolio::components.livewire.wire-mobile-pagination-links') }}
            </div>
