<div x-data="{ modal: false, show: false, on: @entangle('is_active') }">
    <x-shopfolio::breadcrumb back="shopfolio.discounts.index">
        <x-heroicon-s-chevron-left class="shrink-0 h-5 w-5 text-secondary-400" />
        <x-shopfolio::breadcrumb.link :link="route('shopfolio.discounts.index')" title="shopfolio::layout.sidebar.discounts" />
        ...
        <div class="lg:col-span-4 space-y-5">
            <div class="bg-white p-4 sm:p-5 shadow rounded-md dark:bg-secondary-800">
                <div class="w-full mb-3">
                    <div class="flex items-center justify-between">
                        <x-shopfolio::label for="code" :value="__('shopfolio::layout.forms.label.code')" />
                    ...
                    <div class="mt-4 relative rounded-md shadow-sm">
                        <x-shopfolio::forms.input wire:model.lazy="code" id="code" type="text" placeholder="{{ __('Eg.: NOELCMR900') }}" autocomplete="off" />
                        @error('code')
                ...
                <p class="mt-2 text-sm text-secondary-500 leading-5 dark:text-secondary-400">
                    {{ __('shopfolio::pages/discounts.name_helptext') }}
                </p>
            </div>
            <div class="bg-white divide-y divide-secondary-200 shadow rounded-md dark:bg-secondary-800 dark:divide-secondary-700">
                <div class="p-4 sm:p-5">
                    <div class="flex items-center justify-between">
                        <h4 class="text-base leading-5 font-medium text-secondary-900 dark:text-white">{{ __('shopfolio::layout.forms.label.type') }}</h4>
                        <div class="flex items-center space-x-3">
                            <div class="flex items-center">
                                <x-shopfolio::forms.radio wire:model.lazy="type" id="percentage" value="percentage" name="type" />
                                <label for="percentage" class="ml-3 cursor-pointer">
                                    <span class="block text-sm leading-5 font-medium text-secondary-500 dark:text-secondary-400">
                                        {{ __('shopfolio::pages/discounts.percentage') }}
                                    </span>
                                </label>
                            </div>
                            <div class="flex items-center">
                                <x-shopfolio::forms.radio wire:model.lazy="type" id="amount" value="fixed_amount" name="type" />
                                <label for="amount" class="ml-3 cursor-pointer">
                                    <span class="block text-sm leading-5 font-medium text-secondary-500 dark:text-secondary-400">
                                        {{ __('shopfolio::pages/discounts.fixed_amount') }}
                                    </span>
                                </label>
                            </div>
                        </div>
                    ...
                    <div class="mt-5">
                        ...
                        <div class="mt-1 relative rounded-md shadow-sm w-full sm:w-64">
                            <x-shopfolio::forms.input wire:model.lazy="value" id="value" type="text" autocomplete="off" />
                            <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                                <span class="text-secondary-500 sm:text-sm sm:leading-5 dark:text-secondary-400">
                                    {{ $type === 'percentage' ? '%' : shopfolio_currency() }}
                                </span>
                            </div>
                        </div>
                        @error('value')
                ...
                <div class="p-4 sm:p-5">
                    <div class="flex items-center justify-between">
                        <h4 class="text-base leading-5 font-medium text-secondary-900 dark:text-white">
                            {{ __('shopfolio::pages/discounts.applies_to') }}
                        </h4>
                        <div class="flex items-center space-x-3">
                            <div class="flex items-center">
                                <x-shopfolio::forms.radio wire:model.lazy="apply" id="order" value="order" name="apply" />
                                <label for="order" class="ml-3 cursor-pointer">
                                    <span class="block text-sm leading-5 font-medium text-secondary-700 dark:text-secondary-300">
                                        {{ __('shopfolio::pages/discounts.entire_order') }}
                                    </span>
                                </label>
                            </div>
                            <div class="flex items-center">
                                <x-shopfolio::forms.radio wire:model.lazy="apply" id="product" value="products" name="apply" />
                                <label for="product" class="ml-3 cursor-pointer">
                                    <span class="block text-sm leading-5 font-medium text-secondary-700 dark:text-secondary-300">
                                        {{ __('shopfolio::pages/discounts.specific_products') }}
                                    </span>
                                </label>
                            </div>
                        </div>
                    ...
                    @if($apply === 'products')
                        <div class="mt-4">
                            <span class="inline-flex rounded-md shadow-sm">
                                <x-shopfolio::buttons.default wire:click="$emit('openModal', 'shopfolio-modals.discount-products', {{ json_encode(['excludeIds' => $selectedProducts]) }})" type="button">
                                    {{ __('shopfolio::pages/discounts.select_products') }}
                            ...
                            <div class="mt-2 divide-y divide-secondary-100 dark:divide-secondary-700">
                                @foreach($products as $product)
                                    <div class="flex items-center justify-between py-2">
                                        <div class="flex items-center">
                                            @if($product->getFirstMediaUrl(config('shopfolio.system.storage.disks.uploads')))
                                                <span class="shrink-0 h-10 w-10 rounded-md overflow-hidden">
                                                    <img class="object-cover object-center w-full h-full block" src="{{ $product->getFirstMediaUrl(config('shopfolio.system.storage.disks.uploads')) }}" alt="" />
                                                </span>
                                            @else
                ...
                <div class="p-4">
                    <div>
                        <h4 class="text-base leading-5 font-medium text-secondary-900 dark:text-white">
                            {{ __('shopfolio::pages/discounts.min_requirement') }}
                        </h4>
                        <div class="mt-4 space-y-3">
                            <div class="flex items-center">
                                <x-shopfolio::forms.radio wire:model.lazy="minRequired" id="none" value="none" name="min" />
                                <label for="none" class="ml-3 cursor-pointer">
                                    <span class="block text-sm leading-5 text-secondary-700 dark:text-secondary-300">
                                        {{ __('shopfolio::pages/discounts.none') }}
                                    </span>
                                </label>
                            </div>
                            <div>
                                <div class="flex items-center">
                                    <x-shopfolio::forms.radio wire:model.lazy="minRequired" id="price" value="price" name="min" />
                                    <label for="price" class="ml-3 cursor-pointer">
                                        <span class="block text-sm leading-5 text-secondary-700 dark:text-secondary-300">
                                            {{ __('shopfolio::pages/discounts.min_amount', ['currency' => shopfolio_currency()]) }}
                                        </span>
                                    </label>
                                </div>
                                @if($minRequired === 'price')
                                    <div class="mt-2 relative rounded-md shadow-sm w-full sm:w-64">
                                        <x-shopfolio::forms.input
                                            ...
                                            aria-label="{{ __('shopfolio::pages/discounts.min_value') }}"
                                            type="text"
                                            autocomplete="off"
                                            class="sm:w-64"
                                        />
                                    ...
                                    <p class="mt-1 text-sm text-secondary-500 dark:text-secondary-400">
                                        {{ __('shopfolio::pages/discounts.applies_only_selected') }}
                                    </p>
                                @endif
                            </div>
                            <div>
                                <div class="flex items-center">
                                    <x-shopfolio::forms.radio wire:model.debounce.350ms="minRequired" id="quantity" value="quantity" name="min" />
                                    <label for="quantity" class="ml-3 cursor-pointer">
                                        <span class="block text-sm leading-5 text-secondary-700 dark:text-secondary-300">
                                            {{ __('shopfolio::pages/discounts.min_quantity') }}
                                        </span>
                                    </label>
                                </div>
                ...
                <div class="p-4">
                    <div class="flex items-center justify-between">
                        <h4 class="text-base leading-5 font-medium text-secondary-900 dark:text-white">
                            {{ __('shopfolio::pages/discounts.customer_eligibility') }}
                        </h4>
                        <div class="flex items-center space-x-3">
                            <div class="flex items-center">
                                <x-shopfolio::forms.radio wire:model.lazy="eligibility" id="everyone" value="everyone" />
                                <label for="everyone" class="ml-3 cursor-pointer">
                                    <span class="block text-sm leading-5 font-medium text-secondary-500 dark:text-secondary-400">
                                        {{ __('shopfolio::pages/discounts.everyone') }}
                                    </span>
                                </label>
                            </div>
                            <div class="flex items-center">
                                <x-shopfolio::forms.radio wire:model.lazy="eligibility" id="customer" value="customers" />
                                <label for="customer" class="ml-3 cursor-pointer">
                                    <span class="block text-sm leading-5 font-medium text-secondary-500 dark:text-secondary-400">
                                        {{ __('shopfolio::pages/discounts.specific_customers') }}
                                    </span>
                                </label>
                            </div>
                        </div>
                    ...
                    @if($eligibility === 'customers')
                        <div class="mt-4">
                            <span class="inline-flex rounded-md shadow-sm">
                                <x-shopfolio::buttons.default wire:click="$emit('openModal', 'shopfolio-modals.discount-customers', {{ json_encode(['excludeIds' => $selectedCustomers]) }})" type="button">
                                    {{ __('shopfolio::pages/discounts.select_customers') }}
                                </x-shopfolio::buttons.default>
                            </span>
                        </div>
            ...
            <div class="p-4 bg-white shadow rounded-md sm:p-5 dark:bg-secondary-800">
                <h4 class="text-base leading-6 font-medium text-secondary-900 dark:text-white">
                    {{ __('shopfolio::pages/discounts.usage_limits') }}
                </h4>
                <div class="mt-5 space-y-4">
                    <div>
                        <div class="flex items-start">
                            <div class="flex items-center h-5">
                                <x-shopfolio::forms.checkbox wire:model.lazy="usage_number" id="usage_number" />
                            </div>
                            <div class="ml-3 text-sm leading-5">
                                <x-shopfolio::label
                                    for="usage_number"
                                    class="text-secondary-500 cursor-pointer dark:text-secondary-400"
                                    :value="__('shopfolio::pages/discounts.usage_label')"
                                />
                            </div>
                        </div>
                        @if($usage_number)
                            <div class="mt-2">
                                <div class="relative rounded-md shadow-sm w-full sm:w-64">
                                    <x-shopfolio::forms.input
                                        ...
                                        aria-label="{{ __('shopfolio::pages/discounts.usage_value') }}"
                                        type="number"
                                        min="1"
                                        step="1"
                                        autocomplete="off"
                    ...
                    <div class="flex items-start">
                        <div class="flex items-center h-5">
                            <x-shopfolio::forms.checkbox wire:model.lazy="usage_limit_per_user" id="usage_limit_per_user" />
                        </div>
                        <div class="ml-3 text-sm leading-5">
                            <x-shopfolio::label
                                for="usage_limit_per_user"
                                class="text-secondary-500 cursor-pointer dark:text-secondary-400"
                                :value="__('shopfolio::pages/discounts.limit_one_per_user')"
                            />
                        </div>
                    </div>
                </div>
            ...
            <div class="p-4 bg-white shadow rounded-md sm:p-5 dark:bg-secondary-800">
                <h4 class="text-base leading-6 font-medium text-secondary-900 dark:text-white">
                    {{ __('shopfolio::pages/discounts.active_dates') }}
                </h4>
                <div class="space-y-4 mt-4">
                    <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                        <div class="sm:col-span-1">
                            <x-datetime-picker
                                :label="__('shopfolio::pages/discounts.start_date')"
                                :placeholder="__('shopfolio::pages/discounts.choose_start_date')"
                        ...
                        <div class="sm:col-span-1">
                            <x-datetime-picker
                                :label="__('shopfolio::pages/discounts.end_date')"
                                :placeholder="__('shopfolio::pages/discounts.choose_end_date')"
                ...
                <div class="space-y-5">
                    <div class="px-4 py-5 bg-white shadow-md rounded-md sm:px-6 dark:bg-secondary-800">
                        <div class="flex items-center space-x-2">
                            <h4 class="font-medium text-base text-secondary-900 dark:text-white">{{ __('shopfolio::messages.summary') }}</h4>
                            <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full {{ $discount->is_active ? 'bg-green-100 text-green-800': 'bg-orange-100 text-orange-800' }}">
                                {{ $discount->is_active ? __('shopfolio::layout.forms.label.active') : __('shopfolio::layout.forms.label.inactive') }}
                            </span>
                        </div>
                        @if($this->isEmpty())
                            <p class="text-secondary-500 text-sm mt-4 dark:text-secondary-400">{{ __('shopfolio::pages/discounts.empty_code') }}</p>
                        @else
                            ...
                            <ul class="list-disc list-inside mt-4 space-y-1 text-sm text-secondary-500 dark:text-secondary-400">
                                @if($value !== '' && (int) $value > 0)
                                    <li>
                                        ...
                                        <span>{{ __('shopfolio::messages.of') }} {{ $apply === 'order' ? __('shopfolio::pages/discounts.entire_order') : $this->getProductSize() }}</span>
                                    </li>
                                @endif
                                @if($minRequiredValue !== '' && (int) $minRequiredValue > 0 && $minRequired !== 'none')
                                    <li>
                                        <span>{{ __('shopfolio::pages/discounts.min_purchase') }}</span>
                                        {{ $minRequired === 'quantity' ?  __('shopfolio::pages/discounts.count_items', ['count' => $minRequiredValue]) : $this->formattedPrice($minRequiredValue) }}
                                    </li>
                                @endif
                    ...
                    <div class="p-4 bg-white shadow-md rounded-md sm:p-5 dark:bg-secondary-800">
                        <h4 class="text-secondary-900 font-medium text-base leading-6 dark:text-white">
                            {{ __('shopfolio::layout.forms.label.visibility') }}
                        </h4>
                        <p class="text-sm mt-4 font-normal text-secondary-500 leading-5 dark:text-secondary-400">
                            {{ __('shopfolio::messages.actions_label.set_visibility', ['name' => 'discount']) }}
                        </p>
    ...
    <div class="mt-6 pt-5 pb-10 border-t border-secondary-200 dark:border-secondary-700">
        <div class="flex items-center justify-between space-x-4">
            @can('delete_discounts')
                <x-shopfolio::buttons.danger wire:click="$emit('openModal', 'shopfolio-modals.delete-discount', {{ json_encode([$discount->id]) }})" type="button">
                    <x-heroicon-o-trash class="w-5 h-5 -ml-1 mr-2"/>
                    {{ __('shopfolio::layout.forms.actions.delete') }}
