<div>
    <x-shopfolio::heading>
        <x-slot name="title">
            {{ __('shopfolio::layout.sidebar.categories') }}
        </x-slot>
    ...
    @if($total === 0)
        <x-shopfolio::empty-state
            :title="__('shopfolio::pages/categories.title')"
            :content="__('shopfolio::pages/categories.content')"
            :button="__('shopfolio::messages.actions_label.add_new', ['name' => 'category'])"
            permission="add_categories"
            :url="route('shopfolio.categories.create')"
        >
            <div class="shrink-0">
    ...
    @else
        <div class="mt-6">
            <livewire:shopfolio-tables.categories-table />
        </div>
    @endif

    <x-shopfolio::learn-more name="shopfolio::layout.sidebar.categories" link="categories" />
