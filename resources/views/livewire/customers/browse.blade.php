<div>
    <x-shopfolio::heading>
        <x-slot name="title">
            {{ __('shopfolio::layout.sidebar.customers') }}
        </x-slot>
                ...
                @can('add_customers')
                    <div class="flex space-x-3">
                        <span class="shadow-sm rounded-md">
                            <x-shopfolio::buttons.primary :link="route('shopfolio.customers.create')">
    ...
    @if($total === 0)
        <x-shopfolio::empty-state
            :title="__('shopfolio::pages/customers.title')"
            :content="__('shopfolio::pages/customers.content')"
            :button="__('shopfolio::messages.actions_label.add_new', ['name' => 'customer'])"
            permission="add_customers"
            :url="route('shopfolio.customers.create')"
        >
            <div class="shrink-0">
    ...
    @else
        <div class="mt-6">
            <livewire:shopfolio-tables.customers-table />
        </div>
    @endif

    <x-shopfolio::learn-more name="shopfolio::layout.sidebar.customers" link="customers" />
