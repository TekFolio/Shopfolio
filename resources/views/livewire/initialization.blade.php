                            ...
                            <div class="flex items-start py-5 pr-6 space-x-4 text-sm font-medium leading-5">
                                ...
                                <div class="mt-0.5 min-w-0">
                                    <h3 class="text-xs leading-4 font-semibold uppercase tracking-wide @if(($shop_email && empty($shop_name)) || ($shop_name && empty($shop_email))) text-primary-600 dark:text-primary-500 @elseif($this->stepOneState()) text-secondary-900 dark:text-white @else text-secondary-500 dark:text-secondary-400 @endif">
                                        {{ __('shopfolio::pages/settings.initialization.step_one_title') }}
                                    </h3>
                                    <p class="text-sm font-medium leading-5 text-secondary-400 dark:text-secondary-500">
                                        {{ __('shopfolio::pages/settings.initialization.step_one_description') }}
                                    </p>
                                </div>
                            </div>
                        </button>
                            ...
                            <div class="flex items-start px-6 py-5 space-x-4 text-sm font-medium leading-5 lg:pl-9">
                                ...
                                <div class="mt-0.5 min-w-0">
                                    <h3 class="text-xs leading-4 font-semibold uppercase tracking-wide @if(($shop_street_address && empty($shop_city)) || ($shop_city && empty($shop_street_address))) text-primary-600 dark:text-primary-500 @elseif($this->stepTwoState()) text-secondary-900 dark:text-white @else text-secondary-500 dark:text-secondary-400 @endif">
                                        {{ __('shopfolio::pages/settings.initialization.step_two_title') }}
                                    </h3>
                                    <p class="text-sm font-medium leading-5 text-secondary-400 dark:text-secondary-500">
                                        {{ __('shopfolio::pages/settings.initialization.step_two_description') }}
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start py-5 space-x-4 text-sm font-medium leading-5 pl-9">
                                ...
                                <div class="mt-0.5 min-w-0">
                                    <h3 class="text-xs font-semibold leading-4 tracking-wide uppercase text-secondary-900 dark:text-white">
                                        {{ __('shopfolio::pages/settings.initialization.step_tree_title') }}
                                    </h3>
                                    <p class="text-sm font-medium leading-5 text-secondary-400 dark:text-secondary-500">
                                        {{ __('shopfolio::pages/settings.initialization.step_tree_description') }}
                                    </p>
                                </div>
                            </div>
                        </button>
        ...
        <form wire:submit.prevent="store">
            <div id="step-one" class="px-4 sm:px-6 lg:px-8">
                <span class="text-sm font-medium uppercase text-primary-600 lg:hidden dark:text-primary-500">
                    {{ __('shopfolio::pages/settings.initialization.step', ['step' => 1]) }}
                </span>
                <h1 class="mt-2 text-2xl font-bold leading-8 text-secondary-900 lg:text-3xl lg:mt-0 dark:text-white">
                    {{ __('shopfolio::pages/settings.initialization.shop_configuration') }}
                </h1>

                <x-shopfolio::validation-errors />

                <div class="mt-10">
                    <span class="text-sm font-medium text-primary-600 dark:text-primary-500">{{ __('shopfolio::pages/settings.initialization.step_1') }}</span>
                    <h3 class="text-base mt-1.5 font-semibold text-secondary-900 leading-5 dark:text-white">{{ __('shopfolio::pages/settings.initialization.tell_about') }}</h3>
                    <p class="mt-3 text-sm leading-5 text-secondary-500 lg:max-w-xl dark:text-secondary-400">
                        {{ __('shopfolio::pages/settings.initialization.step_1_description') }}
                    </p>
                </div>
            </div>
            ...
            <div class="mt-6 lg:mt-8 sm:px-6 lg:px-8">
                <div class="p-4 space-y-6 bg-white shadow-md sm:rounded-md lg:p-6 dark:bg-secondary-800">
                    <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start">
                        <x-shopfolio::label for="name" class="sm:mt-px sm:pt-2">
                            {{ __('shopfolio::layout.forms.label.store_name') }} <span class="text-red-500">*</span>
                        </x-shopfolio::label>
                        <div class="mt-1 sm:mt-0 sm:col-span-2">
                            <div class="relative rounded-md shadow-sm sm:max-w-xs lg:max-w-lg">
                                ...
                                <x-shopfolio::forms.input id="name" type="text" wire:model.defer="shop_name" class="pl-10" autocomplete="name" autofocus required />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-secondary-200 sm:pt-5 dark:border-secondary-700">
                        <x-shopfolio::label for="email" class="sm:mt-px sm:pt-2">
                            {{ __('shopfolio::layout.forms.label.email') }} <span class="text-red-500">*</span>
                        </x-shopfolio::label>
                        <div class="mt-1 sm:mt-0 sm:col-span-2">
                            <div class="relative rounded-md shadow-sm sm:max-w-xs lg:max-w-lg">
                                <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                ...
                                <x-shopfolio::forms.input wire:model.defer="shop_email" id="email" type="email" class="pl-10" required />
                            </div>
                        </div>
                    </div>

                    <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-secondary-200 sm:pt-5 dark:border-secondary-700">
                        <x-shopfolio::label for="country" class="sm:mt-px sm:pt-2">
                            {{ __('shopfolio::layout.forms.label.country') }} <span class="text-red-500">*</span>
                        </x-shopfolio::label>
                    ...
                    <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-center sm:border-t sm:border-secondary-200 sm:pt-5 dark:border-secondary-700">
                        <x-shopfolio::label for="photo" class="sm:mt-px sm:pt-2" :value="__('shopfolio::layout.forms.label.logo')" />
                        <div class="relative mt-1 sm:mt-0 sm:col-span-2">
                            <x-shopfolio::forms.avatar-upload wire:model.defer="logo" id="photo">
                            ...
                            <p class="mt-2 text-sm text-secondary-500 dark:text-secondary-400">
                                {{ __('shopfolio::pages/settings.logo_description') }}
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="mt-6 sm:mt-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-secondary-200 sm:pt-5 dark:border-secondary-700">
                        <x-shopfolio::label for="about" class="sm:mt-px sm:pt-2" :value="__('shopfolio::layout.forms.label.about')" />
                        <div class="mt-1 sm:mt-0 sm:col-span-2">
                            <div class="flex overflow-x-auto rounded-md shadow-sm sm:max-w-lg lg:w-full lg:overflow-visible">
                                <livewire:shopfolio-forms.trix :value="$shop_about" />
                            </div>
                            <p class="mt-2 text-sm text-secondary-500 dark:text-secondary-400">{{ __('shopfolio::pages/settings.about_description') }}</p>
                        </div>
                    </div>

                    <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-secondary-200 sm:pt-5 dark:border-secondary-700">
                        <x-shopfolio::label for="currency" class="sm:mt-px sm:pt-2" :value="__('shopfolio::layout.forms.label.currency')" />
                        <div class="mt-1 sm:mt-0 sm:col-span-2">
                            <div class="rounded-md shadow-sm sm:max-w-xs lg:max-w-lg" wire:ignore>
                                <select
                            ...
                            <p class="mt-2 text-sm text-secondary-500 dark:text-secondary-400">{{ __('shopfolio::pages/settings.currency_description') }}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div id="step-two" class="px-4 sm:px-6 lg:px-8">
                <div class="pt-8 mt-8 border-t lg:mt-10 lg:pt-10 border-secondary-200 dark:border-secondary-700">
                    <span class="text-sm font-medium text-primary-600 dark:text-primary-500">{{ __('shopfolio::pages/settings.initialization.step_2') }}</span>
                    <h3 class="text-base mt-1.5 font-bold text-secondary-900 leading-5 dark:text-white">{{ __('shopfolio::pages/settings.initialization.address_description') }}</h3>
                    <p class="mt-4 text-sm text-secondary-500 lg:max-w-xl dark:text-secondary-400">
                        {{ __('shopfolio::pages/settings.initialization.step_2_description') }}
                    </p>
                </div>
            </div>
                    ...
                    <div
                            ...
                            @else
                                <div class="flex items-center justify-center overflow-hidden rounded-md outline-none bg-secondary-100 h-95 dark:bg-secondary-900">
                                    <p class="text-base font-medium leading-6 text-secondary-500 dark:text-secondary-400">
                                        {{ __('shopfolio::pages/settings.mapbox_disabled') }}
                                    </p>
                                </div>
                            @endif
                            <p class="text-sm leading-5 text-secondary-500 dark:text-secondary-400">
                                Shopfolio uses <span class="font-medium text-secondary-700 dark:text-secondary-300">Mapbox</span> to make it easier to locate your store.
                        ...
                        <div class="py-2 pr-2">
                            <div class="grid gap-4 lg:grid-cols-4 lg:gap-5">
                                <x-shopfolio::forms.group class="sm:col-span-4" label="shopfolio::layout.forms.label.street_address" for="street_address" isRequired>
                                    <x-shopfolio::forms.input wire:model.defer="shop_street_address" id="street_address" type="text" autocomplete="off" placeholder="Akwa Avenue 34..." />
                                </x-shopfolio::forms.group>

                                <x-shopfolio::forms.group class="sm:col-span-2" label="shopfolio::layout.forms.label.postal_code" for="zipcode" isRequired>
                                    <x-shopfolio::forms.input wire:model.defer="shop_zipcode" id="zipcode" type="text" autocomplete="off" placeholder="00237" required />
                                </x-shopfolio::forms.group>

                                <x-shopfolio::forms.group class="sm:col-span-2" label="shopfolio::layout.forms.label.city" for="city" isRequired>
                                    <x-shopfolio::forms.input wire:model.defer="shop_city" id="city" type="text" autocomplete="off" required />
                                </x-shopfolio::forms.group>

                                <div wire:ignore x-data="internationalNumber('#phone_number')" class="sm:col-span-4">
                                    <x-shopfolio::label for="phone_number" class="sm:mt-px sm:pt-2" :value="__('shopfolio::layout.forms.label.phone_number')" />
                                    <div class="mt-1 sm:mt-0 sm:col-span-2">
                                        <div class="relative rounded-md shadow-sm sm:max-w-xs lg:max-w-lg">
                                            <x-shopfolio::forms.input wire:model.defer="shop_phone_number" id="phone_number" type="tel" class="w-full" autocomplete="off" />
                                        </div>
                                    </div>
                                </div>

                                <x-shopfolio::forms.group class="sm:col-span-2" for="longitude" label="shopfolio::layout.forms.label.longitude" wire:ignore>
                                    <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                    ...
                                    <x-shopfolio::forms.input x-model="lng" x-data x-init="$watch('lng', value => $wire.set('shop_lng', value))" id="longitude" type="text" class="pl-10" autocomplete="off" placeholder="9.795537" readonly />
                                </x-shopfolio::forms.group>

                                <x-shopfolio::forms.group class="sm:col-span-2" for="latitude" label="shopfolio::layout.forms.label.latitude" wire:ignore>
                                    <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                        <svg class="w-5 h-5 text-secondary-400" fill="currentColor" viewBox="0 0 20 20">
                                            <path d="M10 7.083A2.92 2.92 0 0 0 7.083 10 2.92 2.92 0 0 0 10 12.917 2.92 2.92 0 0 0 12.917 10 2.92 2.92 0 0 0 10 7.083zm0 4.167c-.69 0-1.25-.56-1.25-1.25S9.31 8.75 10 8.75s1.25.56 1.25 1.25-.56 1.25-1.25 1.25z" />
                                            <path d="M19.167 9.167H17.45a7.51 7.51 0 0 0-6.618-6.618V.833a.834.834 0 0 0-1.666 0V2.55a7.51 7.51 0 0 0-6.618 6.618H.833a.834.834 0 0 0 0 1.666H2.55a7.51 7.51 0 0 0 6.618 6.618v1.716a.834.834 0 0 0 1.666 0V17.45a7.51 7.51 0 0 0 6.618-6.618h1.716a.834.834 0 0 0 0-1.666zM10 15.833A5.84 5.84 0 0 1 4.167 10 5.84 5.84 0 0 1 10 4.167 5.84 5.84 0 0 1 15.833 10 5.84 5.84 0 0 1 10 15.833z" />
                                    ...
                                    <x-shopfolio::forms.input x-model="lat" x-data x-init="$watch('lat', value => $wire.set('shop_lat', value))" id="latitude" type="text" class="pl-10" autocomplete="off" placeholder="4.02537" readonly />
                                </x-shopfolio::forms.group>
                            </div>
                        </div>
                    </div>
            ...
            <div class="px-4 sm:px-6 lg:px-8">
                <div class="pt-8 mt-8 border-t lg:mt-10 lg:pt-10 border-secondary-200 dark:border-secondary-700">
                    <span class="text-sm font-medium text-primary-600 dark:text-primary-500">{{ __('shopfolio::pages/settings.initialization.step_3') }}</span>
                    <h3 class="text-base mt-1.5 font-bold text-secondary-900 leading-5 dark:text-white">
                        {{ __('shopfolio::pages/settings.initialization.social_description') }}
                        <span class="font-normal text-secondary-500 dark:text-secondary-400">
                            ({{ __('shopfolio::layout.forms.label.optional') }})
                        </span>
                    </h3>
                    <p class="mt-4 text-sm text-secondary-500 lg:max-w-xl dark:text-secondary-400">
                        {{ __('shopfolio::pages/settings.initialization.step_3_description') }}
                    </p>
                </div>

                <div class="p-4 mt-6 bg-white rounded-md shadow-md lg:p-6 dark:bg-secondary-800">
                    <div class="grid grid-cols-6 gap-6">
                        <x-shopfolio::forms.group class="col-span-6 lg:col-span-2" label="Facebook" for="facebook">
                            <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                <svg class="w-5 h-5 text-secondary-400" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M20 10c0-5.523-4.477-10-10-10S0 4.477 0 10c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V10h2.54V7.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V10h2.773l-.443 2.89h-2.33v6.988C16.343 19.128 20 14.991 20 10z" clip-rule="evenodd" />
                                </svg>
                            </div>
                            <x-shopfolio::forms.input wire:model.defer="shop_facebook_link" id="facebook" type="text" class="pl-10" autocomplete="off" placeholder="https://facebook.com/laravelshopper" />
                        </x-shopfolio::forms.group>

                        <x-shopfolio::forms.group class="col-span-6 lg:col-span-2" label="Instagram" for="instagram">
                            <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                <svg class="w-5 h-5 text-secondary-400" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            <x-shopfolio::forms.input wire:model.defer="shop_instagram_link" id="instagram" type="text" class="pl-10" autocomplete="off" placeholder="https://instagram.com/laravelshopper" />
                        </x-shopfolio::forms.group>

                        <x-shopfolio::forms.group class="col-span-6 lg:col-span-2" label="Twitter" for="twitter">
                            <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                <svg class="w-5 h-5 text-secondary-400" fill="currentColor" viewBox="0 0 20 20">
                                    <path d="M6.29 18.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0020 3.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.073 4.073 0 01.8 7.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 010 16.407a11.616 11.616 0 006.29 1.84" />
                                </svg>
                            </div>
                            <x-shopfolio::forms.input wire:model.defer="shop_twitter_link" id="twitter" type="text" class="pl-10" autocomplete="off" placeholder="https://twitter.com/laravelshopper" />
                        </x-shopfolio::forms.group>
                    </div>
                </div>
            </div>
                ...
                <div class="flex justify-end">
                    <span class="inline-flex ml-3 rounded-md shadow-sm">
                        <x-shopfolio::buttons.primary wire:click="store" type="button" wire:loading.attr="disabled">
                            ...
                            {{ __('shopfolio::pages/settings.initialization.action') }}
