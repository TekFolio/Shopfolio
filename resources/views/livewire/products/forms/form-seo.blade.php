<div class="p-4 sm:p-5 bg-white dark:bg-secondary-800 rounded-lg shadow-md overflow-hidden space-y-8">
    <div>
        <h3 class="text-lg leading-6 font-medium text-secondary-900 dark:text-white">
            {{ __('shopfolio::pages/products.seo.title') }}
        </h3>
        <p class="mt-1 max-w-2xl text-sm text-secondary-500 dark:text-secondary-400">
            {{ __('shopfolio::pages/products.seo.description') }}
        </p>
        <p class="mt-1 inline-flex text-sm text-secondary-500 dark:text-secondary-400 leading-5 border-dashed border-b border-secondary-300 dark:border-secondary-700">
            {{ __('shopfolio::pages/products.seo.sub_description') }}
        </p>
    </div>
    <div class="grid gap-4 sm:grid-cols-4 sm:gap-6">
        <div class="sm:col-span-2">
            <div class="space-y-5">
                <x-shopfolio::forms.group label="shopfolio::layout.forms.label.title">
                    <x-shopfolio::forms.input wire:model.defer="seoTitle" id="seo_title" type="text" autocomplete="off" />
                ...
                <div>
                    ...
                    <div class="mt-1 rounded-md shadow-sm">
                        <x-shopfolio::forms.textarea wire:model.defer="seoDescription" id="seo_description" />
                    </div>
                </div>
                <div>
                    <x-shopfolio::forms.group label="shopfolio::layout.forms.label.friendly_url" for="slug" isRequired :error="$errors->first('slug')">
                        <x-shopfolio::forms.input wire:model.defer="slug" id="slug" type="text" autocomplete="off" placeholder="my-custom-url" />
                    </x-shopfolio::forms.group>
                </div>
            </div>
