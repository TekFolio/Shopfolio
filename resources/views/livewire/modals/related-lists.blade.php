...
>
    <x-slot name="title">
        {{ __('shopfolio::pages/products.related.modal.title') }}
    </x-slot>

    <x-slot name="content">
        <div class="py-2">
            <x-shopfolio::forms.search label="shopfolio::pages/products.related.modal.search" placeholder="shopfolio::pages/products.related.modal.search_placeholder" />
        </div>
            ...
            @empty
                <div class="p-4 h-full flex items-center justify-center">
                    <div class="text-center">
                        ...
                        <p class="mt-2 text-base font-medium text-secondary-900 dark:text-white">{{ __('shopfolio::pages/products.related.modal.no_results') }}</p>
                    </div>
                </div>
            @endforelse
        </div>
