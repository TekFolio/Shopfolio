...
>
    <x-slot name="title">
        {{ __('shopfolio::pages/discounts.modals.add_customers') }}
    </x-slot>

    <x-slot name="content">
        <div class="py-2">
            <x-shopfolio::forms.search label="shopfolio::layout.forms.label.search'" placeholder="shopfolio::pages/discounts.modals.search_customer" />
        </div>
    ...
    <x-slot name="buttons">
        <span class="flex w-full rounded-md shadow-sm sm:ml-3 sm:w-auto">
            <x-shopfolio::buttons.primary wire:click="addSelectedCustomers" wire.loading.attr="disabled" type="button">
                <x-shopfolio::loader wire:loading wire:target="addSelectedCustomers" class="text-white" />
                {{ __('shopfolio::pages/discounts.modals.add_selected_customers') }}
