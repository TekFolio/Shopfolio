<div>
    <x-shopfolio::breadcrumb back="shopfolio.reviews.index">
        <x-heroicon-s-chevron-left class="shrink-0 h-5 w-5 text-secondary-400" />
        <x-shopfolio::breadcrumb.link :link="route('shopfolio.reviews.index')" title="shopfolio::layout.sidebar.reviews" />
        ...
        <div class="flex items-center justify-between">
            <div class="space-y-">
                <h3 class="text-lg leading-6 font-medium text-secondary-900 dark:text-white">
                    {{ __('shopfolio::pages/products.reviews.review') }}
                </h3>
                <p class="max-w-2xl text-sm leading-5 text-secondary-500 dark:text-secondary-400">
                    {{ __('shopfolio::pages/products.reviews.subtitle') }}
                </p>
            </div>
            <div class="ml-4">
                <x-shopfolio::buttons.danger wire:click="$emit('openModal', 'shopfolio-modals.delete-review', {{ json_encode([$review->id]) }})" type="button">
        ...
        <div class="mt-6 border-t border-secondary-200 dark:border-secondary-700">
            <dl class="divide-y divide-secondary-200 dark:divide-secondary-700">
                ...
                <div class="py-4 space-y-1 sm:grid sm:py-5 sm:grid-cols-3 sm:gap-4">
                    <dt class="text-sm leading-5 font-medium text-secondary-500 dark:text-secondary-400">
                        {{ __('shopfolio::pages/products.reviews.rating') }}
                    </dt>
                ...
                <div class="py-4 space-y-1 sm:grid sm:py-5 sm:grid-cols-3 sm:gap-4">
                    <dt class="text-sm leading-5 font-medium text-secondary-500 dark:text-secondary-400">
                        {{ __('shopfolio::pages/products.reviews.review_content') }}
                    </dt>
                    <dd class="flex space-x-4 text-sm leading-5 text-secondary-900 sm:mt-0 sm:col-span-2 dark:text-white">
                        <div class="grow">
                ...
                <div class="py-4 space-y-1 sm:grid sm:py-5 sm:grid-cols-3 sm:gap-4">
                    <dt class="text-sm leading-5 font-medium text-secondary-500 dark:text-secondary-400">
                        {{ __('shopfolio::pages/products.reviews.reviewer') }}
                    </dt>
                    <dd class="flex space-x-4 text-sm leading-5 text-secondary-900 sm:mt-0 sm:col-span-2 dark:text-white">
                        <div class="grow">
                ...
                <div class="py-4 space-y-1 sm:grid sm:py-5 sm:grid-cols-3 sm:gap-4">
                    <dt class="text-sm leading-5 font-medium text-secondary-500 dark:text-secondary-400">
                        {{ __('shopfolio::layout.forms.label.created_at') }}
                    </dt>
                    <dd class="flex space-x-4 text-sm leading-5 text-secondary-900 sm:mt-0 sm:col-span-2 dark:text-white">
                        <span class="grow">
                ...
                <div class="py-4 space-y-1 sm:grid sm:py-5 sm:grid-cols-3 sm:gap-4">
                    <dt class="text-sm leading-5 font-medium text-secondary-500 dark:text-secondary-400">
                        {{ __('shopfolio::pages/products.reviews.approved_status') }}
                    </dt>
                    <dd class="flex space-x-4 text-sm leading-5 text-secondary-900 sm:mt-0 sm:col-span-2 dark:text-white">
                        <span class="grow">
                            <span class="inline-flex items-center px-3 py-0.5 rounded-full text-sm font-medium leading-5 {{ $review->approved ? 'bg-green-100 text-green-800': 'bg-orange-100 text-orange-800' }}">
                                {{ $review->approved ? __('shopfolio::pages/products.reviews.published') : __('shopfolio::pages/products.reviews.pending') }}
                            </span>
                        </span>
                        <span class="shrink-0">
                            <span role="checkbox"
