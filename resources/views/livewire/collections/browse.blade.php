<div>
    ...
    <x-shopfolio::heading>
        <x-slot name="title">
            {{ __('shopfolio::layout.sidebar.collections') }}
        </x-slot>
                ...
                @can('add_collections')
                    <div class="flex space-x-3">
                        <span class="shadow-sm rounded-md">
                            <x-shopfolio::buttons.primary :link="route('shopfolio.collections.create')">
    ...
    @if($total === 0)
        <x-shopfolio::empty-state
            :title="__('shopfolio::pages/collections.title')"
            :content="__('shopfolio::pages/collections.content')"
            :button="__('shopfolio::messages.actions_label.add_new', ['name' => 'collection'])"
            permission="add_collections"
            :url="route('shopfolio.collections.create')"
        >
            <div class="shrink-0">
    ...
    @else
        <div class="mt-6">
            <livewire:shopfolio-tables.collections-table />
        </div>
    @endif

    <x-shopfolio::learn-more name="shopfolio::layout.sidebar.collections" link="collections" />
