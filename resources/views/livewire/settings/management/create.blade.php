<div>
    <x-shopfolio::breadcrumb back="shopfolio.settings.users">
        ...
        <x-shopfolio::breadcrumb.link :link="route('shopfolio.settings.users')" title="Users & roles" />
    ...
    <div class="mt-6 pb-10">
        <div>
            ...
            <p class="mt-1 max-w-2xl text-sm leading-5 text-secondary-500 dark:text-secondary-400">
                {{ __('This information will be useful for the administrator to connect to the administration of Shopfolio.') }}
            </p>
        </div>
        ...
        <div class="mt-5 px-4 py-5 sm:px-6 bg-white rounded-md shadow-md overflow-hidden dark:bg-secondary-800">
            <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start">
                ...
                <div class="mt-1 sm:mt-0 sm:col-span-2">
                    <div class="max-w-lg relative rounded-md shadow-sm">
                        <x-shopfolio::forms.input wire:model.lazy="email" id="email" type="email" autocomplete="off" />
                    </div>
                    @error('email')
            ...
            <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start mt-6 sm:mt-5 sm:pt-5 sm:border-t sm:border-secondary-200 sm:dark:border-secondary-700">
                <x-shopfolio::label for="password" class="sm:mt-px sm:pt-2">
                ...
                <div class="mt-1 sm:mt-0 sm:col-span-2">
                    <div class="relative flex items-start">
                        ...
                        <div class="ml-3 text-sm leading-5">
                            <x-shopfolio::label for="send_mail" :value="__('Send Invite')" />
        ...
        <div class="mt-5 px-4 py-5 sm:px-6 bg-white rounded-md shadow-md dark:bg-secondary-800">
            <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start">
                <x-shopfolio::label for="first_name" class="sm:mt-px sm:pt-2">
                    {{ __('First name') }} <span class="text-red-500">*</span>
                </x-shopfolio::label>
                <div class="mt-1 sm:mt-0 sm:col-span-2">
                    <div class="max-w-lg rounded-md shadow-sm">
                        <x-shopfolio::forms.input wire:model.lazy="first_name" type="text" id="first_name" autocomplete="off" />
                    </div>
                    @error('first_name')
                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                    @enderror
            ...
            <div class="mt-6 sm:mt-5 sm:pt-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-secondary-200 sm:dark:border-secondary-700">
                <x-shopfolio::label for="last_name" class="sm:mt-px sm:pt-2">
                    {{ __('Last name') }} <span class="text-red-500">*</span>
                </x-shopfolio::label>
                <div class="mt-1 sm:mt-0 sm:col-span-2">
                    <div class="max-w-lg rounded-md shadow-sm">
                        <x-shopfolio::forms.input wire:model="last_name" type="text" id="last_name" autocomplete="off" />
                    </div>
                    @error('last_name')
                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                    @enderror
            ...
            <div class="mt-6 sm:mt-5 sm:pt-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-secondary-200 sm:dark:border-secondary-700">
                <x-shopfolio::label for="gender" class="sm:mt-px sm:pt-2">
                    {{ __('Gender') }}
                </x-shopfolio::label>
                <div class="mt-1 sm:mt-0 sm:col-span-2">
                    <div class="max-w-lg rounded-md shadow-sm">
                        <x-shopfolio::forms.select wire:model.lazy="gender" id="gender">
            ...
            >
                <x-shopfolio::label for="phone_number" class="sm:mt-px sm:pt-2">
                    {{ __('Phone number') }}
                </x-shopfolio::label>
                <div class="mt-1 sm:mt-0 sm:col-span-2">
                    <div class="max-w-lg rounded-md shadow-sm">
                        <x-shopfolio::forms.input wire:model.lazy="phone_number" type="tel" id="phone_number" />
                        @error('phone_number')
                            <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                                <x-heroicon-s-exclamation-circle class="h-5 w-5 text-red-500" />
                            </div>
                                ...
                                <div class="mt-4 space-y-4">
                                    @foreach($roles as $role)
                                        <div class="flex items-center">
                                            <x-shopfolio::forms.radio wire:model.lazy="role_id" id="role_{{ $role->id }}" name="role_id" value="{{ $role->id }}" />
        ...
        <div class="mt-8 pt-5 border-t border-secondary-200 dark:border-secondary-700">
            <div class="flex justify-end">
                <span class="inline-flex rounded-md shadow-sm">
                    <x-shopfolio::buttons.default :link="route('shopfolio.settings.users')">
                        {{ __('Cancel') }}
