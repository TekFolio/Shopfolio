<div>
    <x-shopfolio::breadcrumb back="shopfolio.settings.index">
        <svg class="w-5 h-5 shrink-0 text-secondary-400" fill="currentColor" viewBox="0 0 20 20">
            <path fill-rule="evenodd" d="M12.707 5.293a1 1 0 010 1.414L9.414 10l3.293 3.293a1 1 0 01-1.414 1.414l-4-4a1 1 0 010-1.414l4-4a1 1 0 011.414 0z" clip-rule="evenodd"/>
        </svg>
        <a href="{{ route('shopfolio.settings.index') }}" class="text-secondary-500 hover:text-secondary-600 dark:text-secondary-400 dark:hover:text-secondary-500">
            {{ __('shopfolio::messages.settings') }}
        </a>
    ...
    <div class="pb-5 mt-2 space-y-4 border-b sm:flex sm:items-center sm:justify-between sm:space-y-0 border-secondary-200 dark:border-secondary-700">
        <div class="flex-1 min-w-0">
            <h2 class="text-2xl font-bold leading-6 text-secondary-900 dark:text-white sm:text-3xl sm:leading-9 sm:truncate">
                {{ __('shopfolio::pages/settings.settings.title') }}
            </h2>
        </div>
    </div>
                ...
                <div class="px-4 py-5 sm:p-6">
                    <div class="grid grid-cols-6 gap-6">
                        <div class="col-span-6">
                            <x-shopfolio::forms.group label="Store name" for="shop_name" isRequired :error="$errors->first('shop_name')">
                                ...
                                <x-shopfolio::forms.input wire:model="shop_name" id="shop_name" type="text" class="pl-10" autocomplete="off" />
                            </x-shopfolio::forms.group>
                        </div>

                        <div class="col-span-6 sm:col-span-3">
                            <x-shopfolio::forms.group label="Email address" for="shop_email" isRequired :error="$errors->first('shop_email')" helpText="Your customers will use this address if they need to contact you.">
                                <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                ...
                                <x-shopfolio::forms.input wire:model.defer="shop_email" id="shop_email" type="email" class="pl-10" autocomplete="off" />
                            </x-shopfolio::forms.group>
                        </div>

                        <div wire:ignore x-data="internationalNumber('#phone_number')" class="col-span-6 sm:col-span-3">
                            <x-shopfolio::forms.group label="Phone number" for="phone_number" :error="$errors->first('shop_phone_number')" helpText="Your customers will use this phone number if they need to call you directly.">
                                <x-shopfolio::forms.input wire:model.defer="shop_phone_number" id="phone_number" type="tel" class="pr-10" autocomplete="off" />
        ...
        <div class="md:grid md:grid-cols-3 md:gap-6">
            ...
            <div class="mt-5 md:mt-0 md:col-span-2">
                <div class="overflow-hidden bg-white rounded-md shadow dark:bg-secondary-800">
                    <div class="px-4 py-5 sm:p-6">
                        <x-shopfolio::forms.group label="Logo" for="logo" :error="$errors->first('logo')" noShadow>
                            <x-shopfolio::forms.avatar-upload wire:model.debounce.550ms="logo" id="photo">
                                <span class="flex items-center justify-center w-12 h-12 overflow-hidden rounded-full bg-secondary-100 dark:bg-secondary-700">
                                    ...
                                    @elseif($shop_logo)
                                        <img class="object-cover w-12 h-12" src="{{ shopfolio_asset($shop_logo) }}" alt="Store logo">
                                    @else
                        ...
                        <div class="mt-6">
                            <x-shopfolio::label value="{{ __('Cover photo') }}" />
                            <div class="mt-1">
                                @if($cover)
                                    <div>
                                ...
                                @elseif($shop_cover)
                                    <div>
                                        <div class="overflow-hidden rounded-md shadow shrink-0">
                                            <img class="object-cover w-full h-40" src="{{ shopfolio_asset($shop_cover) }}" alt="Store Cover image">
                                        </div>
                                        <div class="flex items-center mt-1">
            ...
            <div class="mt-5 md:mt-0 md:col-span-2">
                <div class="bg-white rounded-md shadow dark:bg-secondary-800">
                    <div class="px-4 py-5 sm:p-6">
                        <div class="grid grid-cols-6 gap-6">
                            <div class="col-span-6">
                                <x-shopfolio::forms.group label="Legal name of the company" for="shop_legal_name" isRequired :error="$errors->first('shop_legal_name')">
                                    <x-shopfolio::forms.input wire:model.defer="shop_legal_name" id="shop_legal_name" type="text" autocomplete="off" placeholder="ShopStation LLC" />
                                </x-shopfolio::forms.group>
                            </div>

                            <div class="col-span-6">
                                <x-shopfolio::forms.group label="About" for="about">
                                    <livewire:shopfolio-forms.trix :value="$shop_about" />
                                </x-shopfolio::forms.group>
                            </div>

                            <div class="col-span-6">
                                <x-shopfolio::forms.group label="Address" for="shop_street_address">
                                    <x-shopfolio::forms.input wire:model.defer="shop_street_address" id="shop_street_address" type="text" autocomplete="off" placeholder="Akwa Avenue 34..." />
                                </x-shopfolio::forms.group>
                            </div>

                            <div class="col-span-6">
                                <x-shopfolio::forms.group label="shopfolio::layout.forms.label.country" for="shop_country_id" wire:ignore>
                                    <select
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                <x-shopfolio::forms.group label="shopfolio::layout.forms.label.city" for="shop_city">
                                    <x-shopfolio::forms.input wire:model.defer="shop_city" id="shop_city" type="text" autocomplete="off" />
                                </x-shopfolio::forms.group>
                            </div>

                            <div class="col-span-6 sm:col-span-3">
                                <x-shopfolio::forms.group label="shopfolio::layout.forms.label.postal_code" for="shop_zipcode">
                                    <x-shopfolio::forms.input wire:model.defer="shop_zipcode" id="shop_zipcode" type="text" autocomplete="off" />
                                </x-shopfolio::forms.group>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="px-4 py-5 sm:p-6">
                        <div class="grid grid-cols-6 gap-6">
                            <div class="col-span-6" wire:ignore>
                                <x-shopfolio::forms.group label="shopfolio::layout.forms.label.currency" for="shop_currency_id">
                                    <select
        ...
        <div class="md:grid md:grid-cols-3 md:gap-6">
            ...
            <div class="mt-5 md:mt-0 md:col-span-2">
                <div class="overflow-hidden bg-white rounded-md shadow dark:bg-secondary-800">
                    <div class="px-4 py-5 sm:p-6">
                        <div class="grid grid-cols-6 gap-6">
                            <x-shopfolio::forms.group class="col-span-6" label="Facebook" for="shop_facebook_link">
                                <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                    <svg class="w-5 h-5 text-secondary-400" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd" d="M20 10c0-5.523-4.477-10-10-10S0 4.477 0 10c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V10h2.54V7.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V10h2.773l-.443 2.89h-2.33v6.988C16.343 19.128 20 14.991 20 10z" clip-rule="evenodd" />
                                    </svg>
                                </div>
                                <x-shopfolio::forms.input wire:model.defer="shop_facebook_link" id="shop_facebook_link" type="text" class="pl-10" autocomplete="off" placeholder="https://facebook.com/laravelshopper" />
                            </x-shopfolio::forms.group>

                            <x-shopfolio::forms.group class="col-span-6 sm:col-span-3" label="Instagram" for="shop_instagram_link">
                                <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                    <svg class="w-5 h-5 text-secondary-400" fill="currentColor" viewBox="0 0 24 24">
                                ...
                                <x-shopfolio::forms.input wire:model.defer="shop_instagram_link" id="shop_instagram_link" type="text" class="pl-10" autocomplete="off" placeholder="https://instagram.com/laravelshopper" />
                            </x-shopfolio::forms.group>

                            <x-shopfolio::forms.group class="col-span-6 sm:col-span-3" label="Twitter" for="shop_twitter_link">
                                <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                    <svg class="w-5 h-5 text-secondary-400" fill="currentColor" viewBox="0 0 20 20">
                                        <path d="M6.29 18.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0020 3.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.073 4.073 0 01.8 7.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 010 16.407a11.616 11.616 0 006.29 1.84" />
                                    </svg>
                                </div>
                                <x-shopfolio::forms.input wire:model.defer="shop_twitter_link" id="shop_twitter_link" type="text" class="pl-10" autocomplete="off" placeholder="https://twitter.com/laravelshopper" />
                            </x-shopfolio::forms.group>
                        </div>
                    </div>
                </div>
