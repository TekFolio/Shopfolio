<div>
            ...
            @can('add_inventories')
                @if($inventories->count() < 5)
                    ...
                    <span class="shadow-sm rounded-md">
                        <x-shopfolio::buttons.primary :link="route('shopfolio.settings.inventories.create')">
                            {{ __('Add location') }}
                ...
                <div class="bg-white shadow rounded-md overflow-hidden dark:bg-secondary-800">
                    <ul class="divide-y divide-secondary-200 dark:divide-secondary-700">
                        @foreach($inventories as $inventory)
                            <li>
                                <a href="{{ route('shopfolio.settings.inventories.edit', $inventory) }}" class="block hover:bg-secondary-50 focus:outline-none dark:hover:bg-secondary-700">
    ...
    <x-shopfolio::learn-more name="locations" link="locations" />
</div>
