                    ...
                    <div class="space-y-4">
                        <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                            <div class="sm:col-span-1">
                                <x-shopfolio::forms.group label="Location Name" for="name" :error="$errors->first('name')">
                                    <x-shopfolio::forms.input wire:model.defer="name" id="name" type="text" autocomplete="off" placeholder="White House" />
                                </x-shopfolio::forms.group>
                            </div>
                            <div class="sm:col-span-1">
                                <x-shopfolio::forms.group label="Email" for="email" :error="$errors->first('email')">
                                    <x-shopfolio::forms.input wire:model.defer="email" id="email" type="email" autocomplete="off" />
                                </x-shopfolio::forms.group>
                            </div>
                            <div class="sm:col-span-2">
                                <div class="flex items-center justify-between">
                                    <x-shopfolio::label :value="__('shopfolio::layout.forms.label.description')" for="description" />
                    ...
                    <div class="px-4 py-5 sm:p-6">
                        <div class="grid gap-4 sm:grid-cols-6 sm:gap-6">
                            <div class="sm:col-span-6">
                                <x-shopfolio::forms.group label="Street address" for="street_address" :error="$errors->first('street_address')">
                                    <x-shopfolio::forms.input wire:model.defer="street_address" id="street_address" type="text" autocomplete="off" placeholder="Akwa Avenue 34..." />
                                </x-shopfolio::forms.group>
                            </div>
                            ...
                            <div class="sm:col-span-6">
                                <x-shopfolio::forms.group for="country_id" label="shopfolio::layout.forms.label.country" noShadow wire:ignore>
                                    <select
                            ...
                            <div class="sm:col-span-3">
                                <x-shopfolio::forms.group label="City" for="city" :error="$errors->first('city')">
                                    <x-shopfolio::forms.input wire:model.defer="city" id="city" type="text" autocomplete="off" />
                                </x-shopfolio::forms.group>
                            </div>

                            <div class="sm:col-span-3">
                                <x-shopfolio::forms.group label="Postal / Zip code" for="zipcode" :error="$errors->first('zipcode')">
                            ...
                            >
                                <x-shopfolio::forms.group label="Phone number" for="phone_number" :error="$errors->first('phone_number')">
                                    <x-shopfolio::forms.input wire:model.defer="phone_number" id="phone_number" type="tel" class="pr-10" autocomplete="off" />
                                    @error('phone_number')
