<div>
    <x-shopfolio::breadcrumb back="shopfolio.settings.index">
        ...
        <a href="{{ route('shopfolio.settings.index') }}" class="text-secondary-500 hover:text-secondary-700 focus:outline-none focus:underline transition duration-150 ease-in-out">{{ __('Settings') }}</a>
        ...
        <div class="rounded-md shadow overflow-hidden bg-white">
            ...
            <div class="bg-secondary-50 grid grid-cols-2">
                @if($github)
                    ...
                    <a href="{{ route('shopfolio.settings.integrations.github') }}" class="inline-flex items-center border-l border-secondary-100 text-center py-3 px-4 text-secondary-700 leading-6 text-base font-medium sm:text-sm sm:leading-5 hover:text-secondary-500 focus:outline-none focus:text-secondary-900 transition duration-150 ease-in-out">
                        {{ __("Getting Started") }}
                ...
                @else
                    ...
                    <a href="https://docs.techieslab.net/docs/integrations/github" class="border-l border-secondary-100 text-center py-3 px-4 text-secondary-700 leading-6 text-base font-medium sm:text-sm sm:leading-5 hover:text-secondary-500 focus:outline-none focus:text-secondary-900 transition duration-150 ease-in-out">
                        {{ __("Learn More") }}
                    </a>
                @endif
            </div>
        ...
        <div class="rounded-md shadow overflow-hidden bg-white">
            ...
            <div class="bg-secondary-50 grid grid-cols-2">
                @if($twitter)
                    ...
                    <a href="{{ route('shopfolio.settings.integrations.twitter') }}" class="inline-flex items-center border-l border-secondary-100 text-center py-3 px-4 text-secondary-700 leading-6 text-base font-medium sm:text-sm sm:leading-5 hover:text-secondary-500 focus:outline-none focus:text-secondary-900 transition duration-150 ease-in-out">
                        {{ __("Getting Started") }}
                        <svg class="h-5 w-5 ml-2 -mr-0.5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3" />
                        </svg>
                ...
                @else
                    ...
                    <a href="https://docs.techieslab.net/docs/integrations/twitter" class="border-l border-secondary-100 text-center py-3 px-4 text-secondary-700 leading-6 text-base font-medium sm:text-sm sm:leading-5 hover:text-secondary-500 focus:outline-none focus:text-secondary-900 transition duration-150 ease-in-out">
                        {{ __("Learn More") }}
                    </a>
                @endif
            </div>
    ...
    <x-shopfolio::modal wire:model="confirmModalActivation" id="modal-enable" maxWidth="lg">
        <div class="px-4 pt-5 pb-4 sm:p-6">
            ...
            <div class="mt-4 sm:flex">
                <x-shopfolio::buttons.primary wire:click="enableProvider" type="button" wire:loading.attr="disabled" class="capitalize w-full sm:w-auto sm:text-sm">
                    <x-shopfolio::loader wire:loading wire:target="enableProvider" class="text-white" />
                    {{ __('Enable :provider', ['provider' => $currentProvider]) }}
                </x-shopfolio::buttons.primary>
                <x-shopfolio::buttons.default wire:click="closeIntegrationModal" class="mt-3 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm">
                    {{ __('Cancel') }}
