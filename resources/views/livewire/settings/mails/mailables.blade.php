            ...
            <div class="pb-5 border-b border-secondary-200 sm:flex sm:items-center sm:justify-between dark:border-secondary-700">
                ...
                @if($isLocal)
                    <div class="mt-3 sm:mt-0 sm:ml-4">
                        <x-shopfolio::buttons.primary wire:click="$emit('openModal', 'shopfolio-modals.create-mailable')" type="button">
                                ...
                                <tbody class="bg-white divide-y divide-secondary-200 dark:bg-secondary-800 dark:divide-secondary-700">
                                    @forelse($mailables->all() as $mailable)
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm text-secondary-500 dark:text-secondary-400">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                ...
                                                <button wire:click="$emit('openModal', 'shopfolio-modals.delete-mailable', {{ json_encode(['item' => $mailable['name']]) }})" type="button" class="inline-flex items-center p-2 rounded-full hover:bg-secondary-50 text-secondary-500 text-sm leading-5 hover:text-secondary-400 focus:outline-none dark:text-secondary-400 dark:hover:bg-secondary-700">
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="4" class="px-6 py-3 text-right text-xs font-medium">
                                                <div class="py-10 flex flex-col items-center justify-center">
                                                    <svg class="currentColor w-20" viewBox="0 -1 385.27478 385" xmlns="http://www.w3.org/2000/svg">
                                                        ...
                                                        <g fill="#0e65e5">
                                                            ...
                                                            <path d="m61.441406 218.589844c-3.773437 0-6.828125-3.054688-6.828125-6.824219v-27.308594c0-3.769531 3.054688-6.828125 6.828125-6.828125 3.773438 0 6.824219 3.058594 6.824219 6.828125v27.308594c0 3.769531-3.050781 6.824219-6.824219 6.824219zm0 0" />
                                                            <path d="m75.09375 204.9375h-27.308594c-3.773437 0-6.824218-3.058594-6.824218-6.828125s3.050781-6.824219 6.824218-6.824219h27.308594c3.773438 0 6.828125 3.054688 6.828125 6.824219s-3.054687 6.828125-6.828125 6.828125zm0 0" />
                                                            <path d="m197.972656 307.335938c-3.773437 0-6.824218-3.054688-6.824218-6.824219v-27.308594c0-3.769531 3.050781-6.824219 6.824218-6.824219 3.773438 0 6.828125 3.054688 6.828125 6.824219v27.308594c0 3.769531-3.054687 6.824219-6.828125 6.824219zm0 0" />
                                                            <path d="m211.625 293.683594h-27.304688c-3.773437 0-6.828124-3.054688-6.828124-6.828125 0-3.769531 3.054687-6.824219 6.828124-6.824219h27.304688c3.773438 0 6.828125 3.054688 6.828125 6.824219 0 3.773437-3.054687 6.828125-6.828125 6.828125zm0 0" />
                                                            <path d="m307.199219 41.097656c-3.773438 0-6.824219-3.058594-6.824219-6.828125v-27.304687c0-3.769532 3.050781-6.828125 6.824219-6.828125 3.773437 0 6.828125 3.058593 6.828125 6.828125v27.304687c0 3.769531-3.054688 6.828125-6.828125 6.828125zm0 0" />
                                                            <path d="m320.851562 27.445312h-27.304687c-3.773437 0-6.828125-3.058593-6.828125-6.828124 0-3.769532 3.054688-6.828126 6.828125-6.828126h27.304687c3.773438 0 6.828126 3.058594 6.828126 6.828126 0 3.769531-3.054688 6.828124-6.828126 6.828124zm0 0" />
                                                        </g>
                                                    </svg>
                                                    <span class="mt-4 text-sm text-secondary-500 font-medium dark:text-secondary-400">{{ __("We didn't find anything - just empty space.") }}</span>
                                                </div>
                                            </td>
                                        </tr>
                                    @endforelse
            ...
            <div class="mt-10 bg-secondary-50 p-4 sm:p-5 rounded-md border border-secondary-200 dark:bg-secondary-800 dark:border-secondary-700">
                ...
                <div class="mt-4">
                    <div class="-mx-2 -my-1.5 flex">
                        ...
                        <x-shopfolio::buttons.default link="https://www.paypal.com/paypalme/streamaps" target="_blank" class="ml-3">
