<div>
    <x-shopfolio::breadcrumb back="shopfolio.settings.index">
        ...
        <x-shopfolio::breadcrumb.link :link="route('shopfolio.settings.index')" title="Settings" />
        ...
        <div class="md:grid md:grid-cols-3 md:gap-6">
            <div class="md:col-span-1">
                <div class="px-4 sm:px-0">
                    ...
                    <h3 class="mt-2 text-lg font-bold leading-6 text-secondary-900 dark:text-white">{{ __('Google Analytics') }}</h3>
                ...
                <div class="shadow sm:rounded-md sm:overflow-hidden">
                    <div class="px-4 py-5 sm:p-6 bg-white dark:bg-secondary-800">
                        <div class="grid grid-cols-3 gap-6">
                            <x-shopfolio::forms.group for="google_tracking_id" label="Google Analytics Tracking ID" class="col-span-3">
                                <x-shopfolio::forms.input wire:model="google_analytics_tracking_id" type="text" id="google_tracking_id" placeholder="UA-XXX" />
                            </x-shopfolio::forms.group>
                            <x-shopfolio::forms.group for="google_view_id" label="Google Analytics view ID" class="col-span-3">
                                <x-shopfolio::forms.input wire:model="google_analytics_view_id" type="text" id="google_view_id" placeholder="123456789" />
                            </x-shopfolio::forms.group>
                            <x-shopfolio::forms.group for="analytic_script" label="Google Analytics additional script" class="col-span-3">
                                <x-shopfolio::forms.textarea wire:model="google_analytics_add_js" id="analytic_script" />
                            </x-shopfolio::forms.group>
                        </div>

                        <div class="mt-6">
                            <label class="inline-flex items-center block text-sm leading-5 font-medium text-secondary-700 dark:text-secondary-300">
        ...
        <div class="md:grid md:grid-cols-3 md:gap-6">
            <div class="md:col-span-1">
                <div class="px-4 sm:px-0">
                    ...
                    <h3 class="mt-2 text-lg font-bold leading-6 text-secondary-900 dark:text-white">{{ __('Google Tag Manager') }}</h3>
                    <p class="mt-4 text-sm leading-5 text-secondary-500 dark:text-secondary-400">
                    ...
                    <div class="px-4 py-5 sm:p-6 bg-white dark:bg-secondary-800">
                        <div class="grid grid-cols-6 gap-6">
                            <div class="col-span-6">
                                <x-shopfolio::forms.group for="google_tag_id" label="Your Google Tag Manager account ID">
                                    <x-shopfolio::forms.input wire:model="google_tag_manager_account_id" type="text" id="google_tag_id" placeholder="GTM-XXX" />
                                </x-shopfolio::forms.group>
            ...
            <div class="mt-5 md:mt-0 md:col-span-2">
                <div class="shadow overflow-hidden sm:rounded-md">
                    <div class="px-4 py-5 sm:p-6 bg-white dark:bg-secondary-800">
                        <div class="grid grid-cols-6 gap-6">
                            <div class="col-span-6">
                                <x-shopfolio::forms.group for="pixel_facebook_id" label="Your Facebook Pixel account ID">
                                    <x-shopfolio::forms.input wire:model="facebook_pixel_account_id" type="text" id="pixel_facebook_id" placeholder="12345678" />
                                </x-shopfolio::forms.group>
                                <p class="mt-2 text-sm text-secondary-500 dark:text-secondary-400">
