@if ($paginator->hasPages())
    ...
    @else
        <x-shopfolio::buttons.default type="button" class="relative" wire:click="previousPage" rel="prev" aria-label="{{ __('Previous') }}">
            {{ __('Previous') }}
    ...
    @if ($paginator->hasMorePages())
        <x-shopfolio::buttons.default type="button" wire:click="nextPage" rel="next" class="ml-3 relative" aria-label="{{ __('Next') }}">
            {{ __('Next') }}
        </x-shopfolio::buttons.default>
    @else
